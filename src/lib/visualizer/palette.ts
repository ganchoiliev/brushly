...
/* Curated palette + per-service surfaces. Hex values are approximate — calibrate
   against each brand's official RGB before launch (see brushly-visualizer-content.md).
   Keep the public list ~16–20; the internal/field mode can expose more + free-text. */
